            ...
            <nav class="nav navbar navbar-expand-xl header-hover-menu navbar-light iq-navbar">
                <div class="container-fluid navbar-inner">
                    <a href="./index.html" class="navbar-brand">
                        ...
                        <!--Logo start-->
                        <img class="logo-normal" src="/admin/assets/images/logo.png" alt="#">
                        <img class="logo-normal logo-white" src="/admin/assets/images/logo-white.png"
                            alt="#">
                        <img class="logo-full" src="/admin/assets/images/logo-full.png" alt="#">
                        <img class="logo-full logo-full-white" src="/admin/assets/images/logo-full-white.png"
                            alt="#">
                        <!--logo End--> </a>
                        ...
                        <div class="offcanvas offcanvas-end shadow-none iq-product-menu-responsive" tabindex="-1"
                            ...
                            <div class="offcanvas-body">
                                <ul class="iq-nav-menu list-unstyled">
                                    ...
                                    <li class="nav-item"><a class="nav-link " href="./movie/movie-list.html">Movie
                                            List</a></li>
                                    <li class="nav-item">
                                        <a class="nav-link menu-arrow " data-bs-toggle="collapse" href="#tv-shows"
                                            role="button" aria-expanded="false" aria-controls="tv-shows">
                                            TV Shows
                                            <i class="right-icon">
                                                <svg class="icon-20" width="20" viewBox="0 0 24 24"
                                        ...
                                        <ul aria-expanded="false"
                                            class="iq-header-sub-menu left list-unstyled collapse" id="tv-shows">
                                        ...
                                        <div class="p-0 card-body all-notification">
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <img class="p-1 avatar-40 rounded-pill bg-primary-subtle"
                                                        src="/admin/assets/images/shapes/01.png" alt=""
                                                        loading="lazy">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <img class="p-1 avatar-40 rounded-pill bg-primary-subtle"
                                                            src="/admin/assets/images/shapes/02.png" alt=""
                                                            loading="lazy">
                                                    </div>
                                                    <div class="ms-3 w-100">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <img class="p-1 avatar-40 rounded-pill bg-primary-subtle"
                                                        src="/admin/assets/images/shapes/03.png" alt=""
                                                        loading="lazy">
                                                    <div class="ms-3 w-100">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <img class="p-1 avatar-40 rounded-pill bg-primary-subtle"
                                                        src="/admin/assets/images/shapes/04.png" alt=""
                                                        loading="lazy">
