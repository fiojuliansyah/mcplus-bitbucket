                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-end">
                                All User
                                <h2 class="counter" style="visibility: visible;">{{ $userAllCount }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-end">
                                Student/Parent
                                <h2 class="counter" style="visibility: visible;">{{ $userCount }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-end">
                                Tutor
                                <h2 class="counter" style="visibility: visible;">{{ $tutorCount }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-end">
                                Admin
                                <h2 class="counter" style="visibility: visible;">{{ $adminCount }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <form action="{{ route('admin.users.store') }}" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="createModalLable">Create User</h5>
