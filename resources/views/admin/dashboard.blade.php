                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="icon iq-icon-box-top rounded-circle bg-primary">
                                            <svg class="text-white" fill="none"
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-3">
                                        ...
                                        <p class="mb-0 text-primary"><span><i
                                                    class="fa fa-caret-down me-2"></i></span>35%</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-3">
                                        ...
                                        <p class="mb-0 text-warning"><span><i
                                                    class="fa fa-caret-up me-2"></i></span>50%</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-6 col-xl-3">
                            <div class="card card-block card-stretch card-height">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-3">
                                        <h4 class=" mb-0">+1M</h4>
                                        <p class="mb-0 text-info"><span><i
                                                    class="fa fa-caret-up me-2"></i></span>80%</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="iq-card-body p-0">
                                                <div class="iq-thumb">
                                                    <a href="javascript:void(0)">
                                                        <img src="/admin/assets/images/dashboard/01.jpg"
                                                            class="img-fluid w-100 img-border-radius"
                                                            alt="topImg-01">
                                                    </a>
                                                </div>
                                                <div class="iq-feature-list mt-3">
                                                    ...
                                                    <div class="d-flex align-items-center my-2 iq-ltr-direction">
                                                        <p class="mb-0 me-2"><i
                                                                class="fa-regular fa-eye me-1"></i>134</p>
                                                        <p class="mb-0 "><i
                                                                class="fa-solid fa-download ms-2 me-1"></i>30k</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li class="iq-rated-box swiper-slide">
                                        <div class="iq-card mb-0">
                                            <div class="iq-card-body p-0">
                                                <div class="iq-thumb">
                                                    <a href="javascript:void(0)">
                                                        <img src="/admin/assets/images/dashboard/02.jpg"
                                                            class="img-fluid w-100 img-border-radius"
                                                            alt="topImg-02">
                                                    </a>
                                                </div>
                                                <div class="iq-feature-list mt-3">
                                                    ...
                                                    <div class="d-flex align-items-center my-2 iq-ltr-direction">
                                                        <p class="mb-0 me-2"><i
                                                                class="fa-regular fa-eye me-1"></i>133</p>
                                                        <p class="mb-0 "><i
                                                                class="fa-solid fa-download ms-2 me-1"></i>20k</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li class="iq-rated-box swiper-slide">
                                        <div class="iq-card mb-0">
                                            <div class="iq-card-body p-0">
                                                <div class="iq-thumb">
                                                    <a href="javascript:void(0)">
                                                        <img src="/admin/assets/images/dashboard/03.jpg"
                                                            class="img-fluid w-100 img-border-radius"
                                                            alt="topImg-03">
                                                    </a>
                                                </div>
                                                <div class="iq-feature-list mt-3">
                                                    ...
                                                    <div class="d-flex align-items-center my-2 iq-ltr-direction">
                                                        <p class="mb-0 me-2"><i
                                                                class="fa-regular fa-eye me-1"></i>222</p>
                                                        <p class="mb-0 "><i
                                                                class="fa-solid fa-download ms-2 me-1"></i>40k</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li class="iq-rated-box swiper-slide">
                                        <div class="iq-card mb-0">
                                            <div class="iq-card-body p-0">
                                                <div class="iq-thumb">
                                                    <a href="javascript:void(0)">
                                                        <img src="/admin/assets/images/dashboard/04.jpg"
                                                            class="img-fluid w-100 img-border-radius"
                                                            alt="topImg-04">
                                                    </a>
                                                </div>
                                                <div class="iq-feature-list mt-3">
                                                    ...
                                                    <div class="d-flex align-items-center my-2 iq-ltr-direction">
                                                        <p class="mb-0 me-2"><i
                                                                class="fa-regular fa-eye me-1"></i>122</p>
                                                        <p class="mb-0 "><i
                                                                class="fa-solid fa-download ms-2 me-1"></i>25k</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li class="iq-rated-box swiper-slide">
                                        <div class="iq-card mb-0">
                                            <div class="iq-card-body p-0">
                                                <div class="iq-thumb">
                                                    <a href="javascript:void(0)">
                                                        <img src="/admin/assets/images/dashboard/05.jpg"
                                                            class="img-fluid w-100 img-border-radius"
                                                            alt="topImg-05">
                                                    </a>
                                                </div>
                                                <div class="iq-feature-list mt-3">
                                                    ...
                                                    <div class="d-flex align-items-center my-2 iq-ltr-direction">
                                                        <p class="mb-0 me-2"><i
                                                                class="fa-regular fa-eye me-1"></i>144</p>
                                                        <p class="mb-0 "><i
                                                                class="fa-solid fa-download ms-2 me-1"></i>35k</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li class="iq-rated-box swiper-slide">
                                        <div class="iq-card mb-0">
                                            <div class="iq-card-body p-0">
                                                <div class="iq-thumb">
                                                    <a href="javascript:void(0)">
                                                        <img src="/admin/assets/images/dashboard/06.jpg"
                                                            class="img-fluid w-100 img-border-radius"
                                                            alt="topImg-06">
                                                    </a>
                                                </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="iq-movie">
                                                        <a href="javascript:void(0);"><img
                                                                src="/admin/assets/images/movie-thumb/07.jpg"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="iq-movie">
                                                        <a href="javascript:void(0);"><img
                                                                src="/admin/assets/images/movie-thumb/01.jpg"
                                                                class="img-border-radius avatar-40 img-fluid"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="iq-movie">
                                                        <a href="javascript:void(0);"><img
                                                                src="/admin/assets/images/movie-thumb/05.jpg"
                                                                class="img-border-radius avatar-40 img-fluid"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="iq-movie">
                                                        <a href="javascript:void(0);"><img
                                                                src="/admin/assets/images/movie-thumb/10.jpg"
                                                                class="img-border-radius avatar-40 img-fluid"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="iq-movie">
                                                        <a href="javascript:void(0);"><img
                                                                src="/admin/assets/images/movie-thumb/04.jpg"
                                                                class="img-border-radius avatar-40 img-fluid"
