            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    {{-- <div class="card bg-light quiz-ans-card">
                        <img src="/frontpage/assets/img/shapes/withdraw-bg1.svg" class="quiz-ans-bg1" alt="img">
                        <img src="/frontpage/assets/img/shapes/withdraw-bg2.svg" class="quiz-ans-bg2" alt="img">
                        <div class="card-body">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <span class="icon-box bg-primary-transparent me-2 me-xxl-3 flex-shrink-0"><img
                                                src="/frontpage/assets/img/icon/graduation.svg" alt=""></span>
                                        <div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <span class="icon-box bg-secondary-transparent me-2 me-xxl-3 flex-shrink-0"><img
                                                src="/frontpage/assets/img/icon/book.svg" alt=""></span>
                                        <div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <span class="icon-box bg-success-transparent me-2 me-xxl-3 flex-shrink-0"><img
                                                src="/frontpage/assets/img/icon/bookmark.svg" alt=""></span>
                                        <div>
                    ...
                    <div class="row">
                            ...
                            <div class="course-item-two course-item mx-0">
                                <div class="course-img">
                                    <a href="course-details.html">
                                        <img src="/frontpage/assets/img/course/course-01.jpg" alt="img" class="img-fluid">
                                    </a>
                                    <div
                                    ...
                                    <div class="d-flex justify-content-between mb-2">
                                        <div class="d-flex align-items-center">
                                            <a href="instructor-details.html" class="avatar avatar-sm">
                                                <img src="/frontpage/assets/img/user/user-29.jpg" alt="img"
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="course-item-two course-item mx-0">
                                <div class="course-img">
                                    <a href="course-details.html">
                                        <img src="/frontpage/assets/img/course/course-02.jpg" alt="img" class="img-fluid">
                                    </a>
                                    <div
                                        class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-3">
                                        <a href="javascript:void(0);" class="fav-icon ms-auto"><i
                                ...
                                <div class="course-content">
                                    <div class="d-flex justify-content-between mb-2">
                                        <div class="d-flex align-items-center">
                                            <a href="instructor-details.html" class="avatar avatar-sm">
                                                <img src="/frontpage/assets/img/user/user-30.jpg" alt="img"
                                                    class="img-fluid avatar avatar-sm rounded-circle">
                                            </a>
                                            <div class="ms-2">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="course-item-two course-item mx-0">
                                <div class="course-img">
                                    <a href="course-details.html">
                                        <img src="/frontpage/assets/img/course/course-03.jpg" alt="img" class="img-fluid">
                                    </a>
                                    <div
                                        class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-3">
                                        <a href="javascript:void(0);" class="fav-icon ms-auto"><i
                                ...
                                <div class="course-content">
                                    <div class="d-flex justify-content-between mb-2">
                                        <div class="d-flex align-items-center">
                                            <a href="instructor-details.html" class="avatar avatar-sm">
                                                <img src="/frontpage/assets/img/user/user-31.jpg" alt="img"
                                                    class="img-fluid avatar avatar-sm rounded-circle">
                                            </a>
                                            <div class="ms-2">
                                    ...
                                    <h6 class="title mb-2"><a href="course-details.html">Sketch from A to Z (2024): Become
                                            an app designer</a></h6>
                                    <p class="d-flex align-items-center mb-3"><i
                                            class="fa-solid fa-star text-warning me-2"></i>4.4 (160 Reviews)</p>
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h5 class="text-secondary mb-0">$140</h5>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span
                                                        class="badge badge-sm bg-light border d-inline-flex me-3">#INV001</span>
                                                    <p class="small">Amount : <span
                                                            class="heading-color fw-semibold">$200</span></p>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <span
                                        ...
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span
                                                        class="badge badge-sm bg-light border d-inline-flex me-3">#INV002</span>
                                                    <p class="small">Amount : <span
                                                            class="heading-color fw-semibold">$310</span></p>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <span
                                        ...
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span
                                                        class="badge badge-sm bg-light border d-inline-flex me-3">#INV003</span>
                                                    <p class="small">Amount : <span
                                                            class="heading-color fw-semibold">$270</span></p>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <span
                                        ...
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span
                                                        class="badge badge-sm bg-light border d-inline-flex me-3">#INV004</span>
                                                    <p class="small">Amount : <span
                                                            class="heading-color fw-semibold">$180</span></p>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <span
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span
                                                        class="badge badge-sm bg-light border d-inline-flex me-3">#INV005</span>
                                                    <p class="small">Amount : <span
                                                            class="heading-color fw-semibold">$220</span></p>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <span
