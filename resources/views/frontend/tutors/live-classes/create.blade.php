                    ...
                    <div class="grid grid-cols-12">
                        <div class="col-span-12">
                            <div class="flex items-center gap-10 mb-10">
                                ...
                                <h6 class="text-[20px] text-gray-75 font-semibold">Schedule New Class: {{ $subject->name }}</h6>
                            </div>
                                ...
                                <div class="grid grid-cols-12 gap-5">
                                    ...
                                    <div class="col-span-12 lg:col-span-9">
                                        <div class="grid grid-cols-12 gap-x-10 gap-y-6">
                                            ...
                                            <div class="col-span-12">
                                                <label for="topic_name" class="block mb-2 text-[15px] font-medium text-gray-200">New Topic Name</label>
                                            ...
                                            <div class="col-span-12">
                                                ...
                                                <textarea id="agenda" name="agenda" rows="3" required
                                                    class="bg-gray-1000 border border-gray-950 text-gray-75 placeholder:text-gray-500 rounded-[14px] w-full px-4 py-3"
                                                    placeholder="Enter class agenda or main points"></textarea>
                                            </div>

                                            <div class="col-span-12 lg:col-span-4">
                                                <label for="class_day" class="block mb-2 text-[15px] font-medium text-gray-200">Select Day</label>
                                            ...
                                            <div class="col-span-12 lg:col-span-6">
                                                ...
                                                <div class="space-y-2 mt-2 text-gray-200">
                                                    <div class="flex items-center gap-x-3"><input type="checkbox" name="settings[join_before_host]" value="1" class="size-4 bg-gray-950 rounded border-gray-700 text-blue-600"><span>Join Before Host</span></div>
                                                    <div class="flex items-center gap-x-3"><input type="checkbox" name="settings[host_video]" value="1" class="size-4 bg-gray-950 rounded border-gray-700 text-blue-600"><span>Host Video On</span></div>
                                                    <div class="flex items-center gap-x-3"><input type="checkbox" name="settings[participant_video]" value="1" class="size-4 bg-gray-950 rounded border-gray-700 text-blue-600"><span>Participant Video On</span></div>
                                                    <div class="flex items-center gap-x-3"><input type="checkbox" name="settings[mute_upon_entry]" value="1" class="size-4 bg-gray-950 rounded border-gray-700 text-blue-600"><span>Mute Upon Entry</span></div>
                                                    <div class="flex items-center gap-x-3"><input type="checkbox" name="settings[waiting_room]" value="1" class="size-4 bg-gray-950 rounded border-gray-700 text-blue-600"><span>Enable Waiting Room</span></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-span-12 mt-4">
                                                <button type="submit"
                                                    ...
                                                    <span class="text-black text-[16px] font-semibold">Confirm Schedule</span>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
        ...
        Dropzone.options.myDropzone = {
            ...
            init: function () {
                this.on("addedfile", function (file) {
                    // Optional: truncate or style long names
                });
                ...
                this.on("addedfile", function (file) {
                    file.previewElement.querySelector(".delete-btn").addEventListener("click", function () {
