...
@section('content')
			...
			<section class="banner-section-three d-flex align-items-center">
				<img src="/frontpage/assets/img/bg/bg-3.png" alt="img" class="img-fluid banner-bg-01">
				<img src="/frontpage/assets/img/bg/bg-4.png" alt="img" class="img-fluid banner-bg-02">
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-lg-6 d-flex align-items-center">
							<div class="banner-image aos" data-aos="fade-up">
								<img src="/frontpage/assets/img/hero/hero-2.png" alt="Img">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="course-widget">
						<div class="row row-gap-4">
							<div class="col-lg-3 col-md-6 d-flex">
								<div class="expert-item flex-fill aos" data-aos="fade-up">
									<div class="expert-img">
										<img src="/frontpage/assets/img/icons/icon-24.svg" alt="Img">
									</div>
							...
							<div class="col-lg-3 col-md-6 d-flex">
								<div class="expert-item flex-fill aos" data-aos="fade-up">
									<div class="expert-img">
										<img src="/frontpage/assets/img/icons/icon-25.svg" alt="Img">
									</div>
									<div class="expert-content">
							...
							<div class="col-lg-3 col-md-6 d-flex">
								<div class="expert-item flex-fill aos" data-aos="fade-up">
									<div class="expert-img">
										<img src="/frontpage/assets/img/icons/icon-26.svg" alt="Img">
									</div>
									<div class="expert-content">
							...
							<div class="col-lg-3 col-md-6 d-flex">
								<div class="expert-item flex-fill aos" data-aos="fade-up">
									<div class="expert-img">
										<img src="/frontpage/assets/img/icons/icon-27.svg" alt="Img">
									</div>
									<div class="expert-content">
			...
			<div class="section how-it-works">
				<div class="container">
					<div class="d-flex align-items-center justify-content-between flex-wrap gap-3 aos" data-aos="fade-up">
						...
						<div>
							<a href="course-category-2.html" class="btn btn-secondary btn-xl">View all Categories</a>
						</div>
					</div>
					<div class="mentoring-course aos" data-aos="fade-up">
						<div class="categories-item categories-item-two">			
							<span class="categories-icon">
								<img src="/frontpage/assets/img/category/icons/icon-1.svg" alt="Img">
							</span>		
							<h5><a href="course-category.html">Angular Development</a></h5>
							<p>40 Instructors</p>
						</div>
						<div class="categories-item categories-item-two">			
							<span class="categories-icon">
								<img src="/frontpage/assets/img/category/icons/icon-2.svg" alt="Img">
							</span>		
							<h5><a href="course-category.html">Docker Development</a></h5>
							<p>45 Instructors</p>
						</div>
						<div class="categories-item categories-item-two">			
							<span class="categories-icon">
								<img src="/frontpage/assets/img/category/icons/icon-3.svg" alt="Img">
							</span>		
							<h5><a href="course-category.html">Node JS Frontend</a></h5>
							<p>40 Instructors</p>
						</div>
						<div class="categories-item categories-item-two">			
							<span class="categories-icon">
								<img src="/frontpage/assets/img/category/icons/icon-4.svg" alt="Img">
							</span>		
							<h5><a href="course-category.html">Swift Development</a></h5>
							<p>23 Instructors</p>
						</div>
						<div class="categories-item categories-item-two">			
							<span class="categories-icon">
								<img src="/frontpage/assets/img/category/icons/icon-5.png" alt="Img">
							</span>		
							<h5><a href="course-category.html">React Native</a></h5>
							<p>80 Instructors</p>
						</div>
					</div>
				</div>
			...
			<div class="section new-course">
				<div class="home-three-sec-bg">
					<img src="/frontpage/assets/img/bg/bg-3.png" alt="img" class="img-fluid sec-bg-01">
					<img src="/frontpage/assets/img/bg/bg-4.png" alt="img" class="img-fluid sec-bg-02">
				</div>
				<div class="container">
					<div class="d-flex align-items-center justify-content-between flex-wrap gap-3 aos" data-aos="fade-up">
						<div class="section-header">
						...
						<div>
							<a href="course-list.html" class="btn btn-secondary btn-xl">View all Categories</a>
						</div>
					</div>
						...
						<div class="row">
								...
								<div class="course-item course-item-three mx-0 flex-fill aos" data-aos="fade-up">
									<div class="course-img">
										<a href="course-details.html">
											<img class="img-fluid" alt="Img" src="/frontpage/assets/img/course/course-40.jpg">
										</a>
										<div class="price">
									...
									<div class="course-content">
										<div class="course-user">
											<div class="course-user-img">
												<a href="instructor-profile.html"><img src="/frontpage/assets/img/avatar/avatar-21.jpg" alt="Img" class="img-fluid"></a>
										...
										<div class="course-info d-flex align-items-center">
											<div class="course-lesson d-flex align-items-center">
												<img src="/frontpage/assets/img/icons/icon-3.svg" alt="Img">
												<p>12+ Lesson</p>
											</div>
											<div class="course-time d-flex align-items-center">
												<img src="/frontpage/assets/img/icons/icon-4.svg" alt="Img">
												<p>9hr 30min</p>
											</div>
										</div>
										<div class="d-flex align-items-center justify-content-between">
											...
											<a href="checkout.html" class="btn btn-primary btn-xl d-inline-flex align-items-center"><i class="isax isax-shopping-cart5 me-2"></i>Buy Now</a>
										</div>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-md-6 d-flex">
								<div class="course-item course-item-three mx-0 flex-fill aos" data-aos="fade-up">
									<div class="course-img">
										<a href="course-details.html">
											<img class="img-fluid" alt="Img" src="/frontpage/assets/img/course/course-41.jpg">
										</a>
										<div class="price">
											<h3>$156</h3>
										</div>
									...
									<div class="course-content">
										<div class="course-user">
											<div class="course-user-img">
												<a href="instructor-profile.html"><img src="/frontpage/assets/img/avatar/avatar-22.jpg" alt="Img" class="img-fluid"></a>
												<div class="course-name">
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<div class="course-item course-item-three mx-0 flex-fill aos" data-aos="fade-up">
									<div class="course-img">
										<a href="course-details.html">
											<img class="img-fluid" alt="Img" src="/frontpage/assets/img/course/course-42.jpg">
										</a>
									...
									<div class="course-content">
										<div class="course-user">
											<div class="course-user-img">
												<a href="instructor-profile.html"><img src="/frontpage/assets/img/avatar/avatar-25.jpg" alt="Img" class="img-fluid"></a>
												<div class="course-name">
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<div class="course-item course-item-three mx-0 flex-fill aos" data-aos="fade-up">
									<div class="course-img">
										<a href="course-details.html">
											<img class="img-fluid" alt="Img" src="/frontpage/assets/img/course/course-43.jpg">
										</a>
										<div class="price">
											<h3>$145</h3>
										</div>
									...
									<div class="course-content">
										<div class="course-user">
											<div class="course-user-img">
												<a href="instructor-profile.html"><img src="/frontpage/assets/img/avatar/avatar-24.jpg" alt="Img" class="img-fluid"></a>
												<div class="course-name">
													<h4><a href="instructor-profile.html">Nicole Brown</a></h4>
													<p>Instructor</p>
												</div>
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<div class="course-item course-item-three mx-0 flex-fill aos" data-aos="fade-up">
									<div class="course-img">
										<a href="course-details.html">
											<img class="img-fluid" alt="Img" src="/frontpage/assets/img/course/course-45.jpg">
										</a>
										<div class="price combo">
											<h3>Free</h3>
										</div>
									...
									<div class="course-content">
										<div class="course-user">
											<div class="course-user-img">
												<a href="instructor-profile.html"><img src="/frontpage/assets/img/avatar/avatar-23.jpg" alt="Img" class="img-fluid"></a>
												<div class="course-name">
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<div class="course-item course-item-three mx-0 flex-fill aos" data-aos="fade-up">
									<div class="course-img">
										<a href="course-details.html">
											<img class="img-fluid" alt="Img" src="/frontpage/assets/img/course/course-44.jpg">
										</a>
										<div class="price combo">
											<h3>$200 <span>$990.00</span></h3>
										</div>
									...
									<div class="course-content">
										<div class="course-user">
											<div class="course-user-img">
												<a href="instructor-profile.html"><img src="/frontpage/assets/img/avatar/avatar-26.jpg" alt="Img" class="img-fluid"></a>
												<div class="course-name">
					...
					<div class="row align-items-end">
							...
							<div class="career-group aos" data-aos="fade-up">
								<div class="row row-gap-4">
									<div class="col-lg-6 col-md-6 d-flex">
										<div class="certified-item d-flex align-items-center flex-fill">
											<div class="certified-img ">
												<img src="/frontpage/assets/img/icons/icon-22.svg" alt="Img" class="img-fluid">
											</div>
									...
									<div class="col-lg-6 col-md-6 d-flex">
										<div class="certified-item d-flex align-items-center flex-fill">
											<div class="certified-img ">
												<img src="/frontpage/assets/img/icons/icon-17.svg" alt="Img" class="img-fluid">
											</div>
									...
									<div class="col-lg-6 col-md-6 d-flex">
										<div class="certified-item d-flex align-items-center flex-fill">
											<div class="certified-img "><img src="/frontpage/assets/img/icons/icon-23.svg" alt="Img" class="img-fluid">
											</div>
									...
									<div class="col-lg-6 col-md-6 d-flex">
										<div class="certified-item d-flex align-items-center flex-fill">
											<div class="certified-img ">
												<img src="/frontpage/assets/img/icons/icon-16.svg" alt="Img" class="img-fluid">
											</div>
						...
						<div class="col-lg-6 col-md-12">
							<div class="career-img aos" data-aos="fade-up">
								<img src="/frontpage/assets/img/bg/bg-2.png" alt="Img" class="img-fluid master-bg">
								<img src="/frontpage/assets/img/feature/feature-16.png" alt="Img" class="img-fluid girl-img">
								<img src="/frontpage/assets/img/icons/icon-18.svg" alt="Img" class="img-fluid float-img-01">
								<img src="/frontpage/assets/img/icons/icon-19.svg" alt="Img" class="img-fluid float-img-02">
								<img src="/frontpage/assets/img/icons/icon-20.svg" alt="Img" class="img-fluid float-img-03">
								<img src="/frontpage/assets/img/icons/icon-21.svg" alt="Img" class="img-fluid float-img-04">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="section trend-course">
				...
				<div class="container">
					<div class="d-flex align-items-center justify-content-between flex-wrap gap-3 aos" data-aos="fade-up">
						...
						<div>
							<a href="course-list.html" class="btn btn-secondary btn-xl">View all Courses</a>
						</div>
					</div>
							...
							<div class="course-box trend-box">
								<div class="course-item course-item-three mx-0 flex-fill aos" data-aos="fade-up">
									...
									<div class="course-content">
										<div class="course-user">
											<div class="course-user-img">
												<a href="instructor-profile.html"><img src="/frontpage/assets/img/avatar/avatar-27.jpg" alt="Img" class="img-fluid"></a>
												<div class="course-name">
										...
										<div class="course-info d-flex align-items-center">
											<div class="course-lesson d-flex align-items-center">
												<img src="/frontpage/assets/img/icons/icon-3.svg" alt="Img" class="img-fluid">
												<p>13+ Lesson</p>
											</div>
											<div class="course-time d-flex align-items-center">
												<img src="/frontpage/assets/img/icons/icon-4.svg" alt="Img" class="img-fluid">
												<p>10hr 30min</p>
											</div>
										</div>
										<div class="d-flex align-items-center justify-content-between">
					...
					<div class="feature-instructors">
						...
						<div class="instructors-course aos" data-aos="fade-up">
							<div class="instructor-item instructor-item-two">
								<div class="instructors-img">
									<a href="instructor-list.html" tabindex="0">
										<img class="img-fluid" alt="Img" src="/frontpage/assets/img/instructor/instructor-09.jpg">
									</a>
									<div class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-3">
										<span class="verify">
											<i class="isax isax-verify5"></i>
										</span>
										<a href="course-list.html" class="course-count ms-auto">20 Courses</a>
									</div>
								...
								<div class="instructor-content">
									<h3 class="title">
										<a href="instructor-details.html">David Lee</a>
									</h3>
							...
							<div class="instructor-item instructor-item-two">
								<div class="instructors-img">
									<a href="instructor-list.html" tabindex="0">
										<img class="img-fluid" alt="Img" src="/frontpage/assets/img/instructor/instructor-10.jpg">
									</a>
									<div class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-3">
										<a href="course-list.html" class="course-count ms-auto">15 Courses</a>
									</div>
									<div class="position-absolute end-0 bottom-0 d-flex align-items-start w-100 z-index-2 p-3">
								...
								<div class="instructor-content">
									<h3 class="title">
										<a href="instructor-details.html">Daziy Millar</a>
									</h3>
							...
							<div class="instructor-item instructor-item-two">
								<div class="instructors-img">
									<a href="instructor-list.html" tabindex="0">
										<img class="img-fluid" alt="Img" src="/frontpage/assets/img/instructor/instructor-11.jpg">
									</a>
									<div class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-3">
										<span class="verify">
											<i class="isax isax-verify5"></i>
										</span>
										<a href="course-list.html" class="course-count ms-auto">22 Courses</a>
									</div>
									<div class="position-absolute end-0 bottom-0 d-flex align-items-start w-100 z-index-2 p-3">
										<a href="javascript:void(0);" class="favourite ms-auto">
											<i class="isax isax-heart"></i>
								...
								<div class="instructor-content">
									<h3 class="title">
										<a href="instructor-details.html">Patricia Mendoza</a>
									</h3>
									<span class="designation">Web Developer</span>
									<div class="student-count">
							...
							<div class="instructor-item instructor-item-two">
								<div class="instructors-img">
									<a href="instructor-list.html" tabindex="0">
										<img class="img-fluid" alt="Img" src="/frontpage/assets/img/instructor/instructor-12.jpg">
									</a>
									<div class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-3">
										<span class="verify">
											<i class="isax isax-verify5"></i>
								...
								<div class="instructor-content">
									<h3 class="title">
										<a href="instructor-details.html">Skyler Whites</a>
									</h3>
							...
							<div class="instructor-item instructor-item-two">
								<div class="instructors-img">
									<a href="instructor-details.html" tabindex="0">
										<img class="img-fluid" alt="Img" src="/frontpage/assets/img/instructor/instructor-10.jpg">
									</a>
									<div class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-3">
										<a href="course-list.html" class="course-count ms-auto">15 Courses</a>
				...
				<div class="container">
					...
					<div class="lead-group aos" data-aos="fade-up">
						<div class="lead-group-slider owl-carousel owl-theme">
							<div class="item">
								<div class="lead-img">
									<img class="img-fluid" alt="Img" src="/frontpage/assets/img/client/22.svg">
								</div>
							</div>
							<div class="item">
								<div class="lead-img">
									<img class="img-fluid" alt="Img" src="/frontpage/assets/img/client/23.svg">
								</div>
							</div>
							<div class="item">
								<div class="lead-img">
									<img class="img-fluid" alt="Img" src="/frontpage/assets/img/client/24.svg">
								</div>
							</div>
							<div class="item">
								<div class="lead-img">
									<img class="img-fluid" alt="Img" src="/frontpage/assets/img/client/25.svg">
								</div>
							</div>
							<div class="item">
								<div class="lead-img">
									<img class="img-fluid" alt="Img" src="/frontpage/assets/img/client/26.svg">
								</div>
							</div>
							<div class="item">
								<div class="lead-img">
									<img class="img-fluid" alt="Img" src="/frontpage/assets/img/client/27.svg">
								</div>
							</div>							
						</div>
					</div>
					...
					<div class="row align-items-center row-gap-4">
						<div class="col-md-6">
							<div class="knowledge-img aos" data-aos="fade-up">
								<img src="/frontpage/assets/img/feature/feature-17.svg" alt="Img" class="img-fluid">
							</div>
						</div>
						<div class="col-md-6 d-flex align-items-center"> 
							<div class="join-mentor aos" data-aos="fade-up">
								...
								<div>
									<a href="instructor-list.html" class="btn btn-secondary btn-xl">Read More</a>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="d-flex justify-content-center">
								<div class="testimonial-all">
									<div class="testimonial-quotes">
										<img src="/frontpage/assets/img/icons/icon-28.png" alt="Img" >
									</div>
									<div class="testimonial-content text-center align-items-center d-flex">
										<div class="testimonial-info ">
											<div class="testimonial-icon">
												<img src="/frontpage/assets/img/icons/icon-29.png" alt="Img">
											</div>
											...
											<div class="testimonial-user">
												...
												<h6><a href="instructor-profile.html">Daziy Millar</a></h6>
									...
									<div class="testimonial-content text-center align-items-center d-flex">
										<div class="testimonial-info ">
											...
											<div class="testimonial-user">
												...
												<h6><a href="instructor-profile.html">john smith</a></h6>
												<span>Founder of Awesomeux Technology</span>
											</div>
										</div>
									</div>
									...
									<div class="testimonial-content text-center align-items-center d-flex">
										<div class="testimonial-info ">
											...
											<div class="testimonial-user">
												...
												<h6><a href="instructor-profile.html">David Lee</a></h6>
												<span>Founder of Awesomeux Technology</span>
											</div>
										</div>
									</div>
			...
			<div class="section become-instructors aos" data-aos="fade-up">
				<img src="/frontpage/assets/img/bg/bg-5.png" alt="" class="img-fluid become-instructors-bg1">
				<img src="/frontpage/assets/img/bg/bg-6.png" alt="" class="img-fluid become-instructors-bg2">
				<div class="container">
								...
								<div class="row align-items-center">
									<div class="col-lg-7 col-md-12">
										<div class="top-instructors">
											...
											<a href="become-an-instructor.html" class="btn btn-secondary btn-xl">Register as Instructor</a>
										</div>
									</div>
									<div class="col-lg-5 col-md-12">
										<div class="mentor-img">
											<img class="img-fluid d-none d-lg-flex" alt="Img" src="/frontpage/assets/img/feature/feature-15.svg">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="row align-items-center">
									...
									<div class="col-lg-5 col-md-12">
										<div class="mentor-img d-none d-lg-flex">
											<img class="img-fluid" alt="Img" src="/frontpage/assets/img/feature/feature-14.svg">
										</div>
									</div>
								</div>
							</div>
				...
				<div class="container">
							...
							<div class="blog-wrap shadow-sm mb-0">
								<div class="blog-img">
									<a href="blog-grid.html">
										<img class="img-fluid" alt="Img" src="/frontpage/assets/img/blog/blog-40.jpg">
									</a>
								</div>
								<div class="blog-content"> 
									...
									<h5><a href="blog-grid.html">How to Find the Perfect Mentor for Your Academic Journey</a></h5>
								</div>	
							</div>
						</div>
						<div class="col-md-6 col-lg-4">
							<div class="blog-wrap shadow-sm mb-0">
								<div class="blog-img">
									<a href="blog-grid.html">
										<img class="img-fluid" alt="Img" src="/frontpage/assets/img/blog/blog-41.jpg">
									</a>
								</div>
								<div class="blog-content"> 
									<div class="blog-info mb-3">
									...
									<h5><a href="blog-grid.html">Unlocking Your Potential in School and Beyond</a></h5>
								</div>	
							</div>
						</div>
						<div class="col-md-6 col-lg-4">
							<div class="blog-wrap shadow-sm mb-0">
								<div class="blog-img">
									<a href="blog-grid.html">
										<img class="img-fluid" alt="Img" src="/frontpage/assets/img/blog/blog-42.jpg">
									</a>
								</div>
								<div class="blog-content"> 
									<div class="blog-info mb-3">
									...
									<h5><a href="blog-grid.html">11 Tips to Help You Get New Clients with the design knowledge</a></h5>
								</div>	
							</div>
						</div>
					</div>
					<div class="enroll-group aos" data-aos="fade-up">
						<div class="row row-gap-3 justify-content-center">
							<div class="col-lg-4 col-md-6">
								<div class="enroll-course d-flex align-items-center">
									<div class="enroll-img">
										<img src="/frontpage/assets/img/icons/icon-5.svg" alt="Img" class="img-fluid">
									</div>
							...
							<div class="col-lg-4 col-md-6">
								<div class="enroll-course d-flex align-items-center">
									<div class="enroll-img ">
										<img src="/frontpage/assets/img/icons/icon-6.svg" alt="Img" class="img-fluid">
									</div>
									<div class="course-count">
							...
							<div class="col-lg-4 col-md-6">
								<div class="enroll-course d-flex align-items-center">
									<div class="enroll-img ">
										<img src="/frontpage/assets/img/icons/icon-7.svg" alt="Img" class="img-fluid">
									</div>
									<div class="course-count">
					...
					<div class="lab-course">
						<div class="client-slider aos" data-aos="fade-up">
							<div>
								<img src="/frontpage/assets/img/icons/icon-8.svg" alt="Img" class="img-fluid">
							</div>
							<div>
								<img src="/frontpage/assets/img/icons/icon-9.svg" alt="Img" class="img-fluid">
							</div>
							<div>
								<img src="/frontpage/assets/img/icons/icon-10.svg" alt="Img" class="img-fluid">
							</div>
							<div>
								<img src="/frontpage/assets/img/icons/icon-11.svg" alt="Img" class="img-fluid">
							</div>
							<div>
								<img src="/frontpage/assets/img/icons/icon-12.svg" alt="Img" class="img-fluid">
							</div>
							<div>
								<img src="/frontpage/assets/img/icons/icon-13.svg" alt="Img" class="img-fluid">
							</div>
							<div>
								<img src="/frontpage/assets/img/icons/icon-14.svg" alt="Img" class="img-fluid">
							</div>
							<div>
								<img src="/frontpage/assets/img/icons/icon-15.svg" alt="Img" class="img-fluid">
							</div>
						</div>
					</div>
				</div>
