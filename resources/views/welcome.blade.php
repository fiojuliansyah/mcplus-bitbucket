<html>
  <head>
    ...
    <link rel="stylesheet" href="/landing/src/styles.css" />
    <link
      rel="stylesheet"
    ...
    <link
      rel="icon"
      href="/frontend/assets/images/logo-example.png"
    />
  </head>
  <body>
    <!--------------------------  ----------------------------->
    ...
    <header>
      <nav class="navbar">
        <div class="navbar-brand">
          <img
            src="/frontend/assets/images/logo-example.png"
            alt="logo"
            class="Netflix-logo"
          />
        </div>
    ...
    <main>
      <section class="netflix-bg">
        <div class="netflix-bg-container">
          <img
            src="/landing/resources/netflix-bg.jpg"
      ...
      <section class="features-container">
        ...
        <div class="feature">
          ...
          <div class="feature-image-container">
            <img
              src="/landing/resources/tv-1.png"
              alt="Feature image"
              class="feature-image"
            />
            <div class="feature-bg-video-container">
              <video autoplay="" loop="" muted="" class="feature-bg-video">
                <source src="/landing/resources/video-1.m4v" type="video/mp4" />
              </video>
            </div>
          </div>
        </div>
        ...
        <div class="feature">
          ...
          <div class="feature-image-container">
            <img
              src="/landing/resources/mobile.jpg"
              alt="Feature image"
              class="feature-image"
            />
            <div class="feature-2-poster-container">
              <div class="poster-container">
                <img src="/landing/resources/boxshot.png" alt="poster" class="poster" />
              </div>
              ...
              <div class="download-gif-container">
                <img
                  src="/landing/resources/download-icon.gif"
                  alt="downloading gif"
                  class="gif"
                />
              </div>
        ...
        <div class="feature">
          ...
          <div class="feature-image-container feature-3-image-container">
            <img
              src="/landing/resources/tv-2.png"
              alt="Feature image"
            ...
            >
              ...
              >
                <source src="/landing/resources/video-2.m4v" type="video/mp4" />
              </video>
            </div>
          </div>
        </div>
        ...
        <div class="feature">
          ...
          <div class="feature-image-container">
            <img
              src="/landing/resources/children.png"
              alt="Feature image"
              class="feature-image"
            />
          </div>
    ...
    <script src="/landing/src/index.js"></script>
  </body>
</html>
